        ...
        try:
            ...
            messages.append({
                ...
                "content": (
                    ...
                    f"3. Content & depth: use the full product knowledge in your context. "
                    f"When the user asks about products or services, write substantive paragraphs that explain "
                    f"what each product does, what problem it solves, and why it fits their specific situation. "
                    f"If the user mentioned their industry or company type, tie the product directly to their world "
                    f"(e.g. delivery company → customer addresses, driver records, payment data). "
                    f"Do not give a one-liner summary. Actually sell.\n"
