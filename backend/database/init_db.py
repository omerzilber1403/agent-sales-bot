...
def seed_surf_club():
    ...
    try:
        inserted = _upsert_company(db, "geula-surf.co.il", dict(
            ...
            icp=None,
            differentiators=[
                "יחס אישי מובטח: קבוצות קטנות של עד 3 גולשים למדריך (במועדונים אחרים 6-8) — מבטיח עמידה על הגל כבר בשיעור הראשון",
                "ציוד פרימיום: גלשני סופט חדישים + חליפות Rip Curl 4/3mm — לא מתפשרים, תזיע במים גם בחורף",
                "לוקיישן מושלם למתחילים: שבירת גלים רכה, מים רדודים, חניה חינם קרובה",
                "צילום GoPro כלול בכל שיעור — יש מה להעלות לאינסטגרם",
                "כל המדריכים גם מצילים מוסמכים — בטיחות מקסימלית בים",
            ],
            objections_playbook=[
                {
                    "objection": "זה קצת יקר לי / ראיתי במועדון אחר בזול יותר",
                    "response": (
                        "אני מבין לגמרי. ההבדל הוא שאצלנו בקבוצה יש גג 3 אנשים, "
                        "מה שאומר שהמדריך איתך במים צמוד. "
                        "במועדונים אחרים זול יותר כי דוחסים 8 אנשים בקבוצה, ובסוף תופסים פחות גלים. "
                        "אצלנו ההתקדמות הרבה יותר מהירה."
                    ),
                },
                {
                    "objection": "אין לי כושר / אני מפחד מהים / אני מבוגר מדי",
                    "response": (
                        "שומע את זה המון! השיעורים שלנו מותאמים לאפס ניסיון ולכל גיל. "
                        "אנחנו מתחילים במים רדודים עד גובה המותניים עם גלשני סופט בטיחותיים וענקיים. "
                        "כל המדריכים שלנו הם גם מצילים מוסמכים."
                    ),
                },
                {
                    "objection": "קר לי מדי / אין לי זמן עכשיו",
                    "response": (
                        "לגבי הקור — עם חליפות הפרימיום שלנו אתה תזיע במים, בהתחייבות. "
                        "לגבי הזמן — אנחנו גמישים לגמרי, יש לנו סשנים גם בזריחה וגם בשקיעה "
                        "כדי שיתאים ללו\"ז שלך."
                    ),
                },
            ],
            discovery_questions=[
                "איזה כיף שפנית אלינו! 🌊 רק כדי שאתאים לך את המסלול המדויק — מה רמת הגלישה שלך כרגע? (אפס ניסיון / תפסתי כבר כמה גלים בעבר)",
                "אלוף. אתה מחפש שיעור לעצמך, לילד, או אולי איזה סשן לקבוצת חברים?",
                "מה המטרה העיקרית שלך? פשוט לחוות את הים ולהצליח לעמוד, או שאתה רוצה להיכנס לזה ברצינות ולקחת כרטיסייה?",
            ],
            faq_kb_refs=[
                {
            ...
            case_studies=[
                {
                    "title": "יוסי, 42 — 'הייתי בטוח שאני מבוגר מדי'",
                    "industry": "B2C / Adult beginner",
                    "result": (
                        "הגיע סקפטי לשיעור הראשון. "
                        "בשיעור השני של הכרטיסייה כבר רץ על הגל עד החוף. "
                        "זה הכל עניין של הדרכה נכונה."
                    ),
                },
                {
                    "title": "מאיה — ביקורת 5 כוכבים",
                    "industry": "B2C / Package buyer",
                    "result": (
                        "'לקחתי את כרטיסיית ה-5 שיעורים וזו ההחלטה הכי טובה שעשיתי. "
                        "היחס המטורף של המדריכים פשוט שווה כל שקל.'"
                    ),
                },
            ],
            handoff_rules={
            ...
            custom_prompt=(
                "אתה סוכן המכירות של 'מועדון גלישה אלמוג'. "
                "הטון שלך חם, זורם, קליל ומלא אנרגיה של ים. "
                "השתמש באימוג'יז (🤙, 🌊, 🏄‍♂️, ☀️) במידה הנכונה.\n\n"
                "חוקי ברזל:\n"
                "1. לעולם אל תציג מחירים בהודעה הראשונה. "
                "קודם כל תשתמש בשאלת חקר (Discovery) כדי להבין את הלקוח.\n"
                "2. אם לקוח מביע חשש, השתמש ב-objections_playbook בסבלנות ובאמפתיה.\n"
                "3. דבר קצר ולעניין, כמו הודעת וואטסאפ מחבר — אל תכתוב מגילות.\n"
                "4. ברגע שהלקוח מראה נכונות וסגרתם על סוג השיעור, "
                "שלח לו קריאה לפעולה ברורה לקביעת שיעור ראשון.\n\n"
                "כשלוקח מהסס על מחיר או כרטיסייה — שתף את הסיפור של מאיה (case_studies). "
                "כשמהסס בגלל גיל/כושר — שתף את הסיפור של יוסי (case_studies). "
