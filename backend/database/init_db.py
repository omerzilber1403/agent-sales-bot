...
def seed_surf_club():
    """מועדון גלישה אלמוג — B2C surf club demo company."""
    db = SessionLocal()
    try:
        inserted = _upsert_company(db, "geula-surf.co.il", dict(
            name="מועדון גלישה אלמוג",
            domain="geula-surf.co.il",
            locale="he-IL",
            timezone="Asia/Jerusalem",
            currency="ILS",
            business_type="B2C",
            one_line_value="שיעורי גלישה מקצועיים על חוף גורדון, תל אביב — לכל הרמות, מתחילים ועד מתקדמים.",
            products=[
                {
                    "id": "single_lesson",
                    ...
                    "base_price": "₪280",
                    "details": (
                        "מדריך אישי לכל 2-3 תלמידים. ציוד כלול (גלשן + חליפת ניאופרן). "
                        "מתחילים — מלמדים את יסודות הגלישה בחוף הרדוד. "
                        "מבוגרים ומתקדמים — עובדים על תנוחה, כניסה לגלים וטכניקה. "
                        "אפשר לקבוע ב-07:00, 09:30 או 16:00."
                    ),
                    "addons": "שיעור פרטי 1:1 — ₪380",
                },
                {
                    "id": "package_5",
                    ...
                    "base_price": "₪1,200",
                    "details": (
                        "חיסכון של ₪200 לעומת מחיר שיעור יחיד. תוקף 3 חודשים. "
                        "הכי מומלץ — אחרי 5 שיעורים רוב התלמידים גולשים גלים בצורה עצמאית. "
                        "ניתן לחלק: 2 שיעורים בשבוע או בקצב שמתאים לך."
                    ),
                    "addons": "חבילת 10 שיעורים — ₪2,200 (חיסכון של ₪600)",
                },
                {
                    "id": "equipment_rental",
                    ...
                    "base_price": "₪120 ליום",
                    "details": (
                        "גלשנים בגדלים שונים — Softboard למתחילים, Funboard ו-Shortboard למתקדמים. "
                        "חליפות ניאופרן 3/2mm לכל המידות (S עד XXL). "
                        "השכרה מ-07:00 עד שקיעה."
                    ),
                    "addons": "חבילת ציוד שבועית — ₪500 לשבוע",
                },
                {
                    "id": "kids_summer_camp",
                    "name": "קייטנת גלישה לילדים",
                    "summary": "קייטנת ים לילדים גילאי 8-16 — שבוע של גלישה, כיף וחוף.",
                    "base_price": "₪1,400 לשבוע",
                    "details": (
                        "ימים א'-ה', 08:00-13:00. "
                        "קבוצות עד 10 ילדים עם 2 מדריכים. "
                        "כולל ציוד, שיעורי בטיחות בים, ו-certificate של מועדון אלמוג בסוף השבוע. "
                        "מומלץ לגילאי 8-16, לא נדרש ניסיון קודם."
                    ),
                },
            ],
            pain_points=[
                "פחד מהגלים ולא יודעים מאיפה להתחיל",
                "ציוד גלישה יקר מאוד לרכישה — גלשן איכותי עולה ₪2,000-5,000",
                "חוסר ביטחון — 'אני כבר גדול מדי / לא ספורטיבי מספיק / מפחד'",
                "לא יודעים איזה מדריך לבחור — חוששים לבזבז כסף על שיעור גרוע",
                "הורים שרוצים פעילות ים לילדים בקיץ אבל לא יודעים מה בטוח",
            ],
            brand_voice={
                "style": "חברותי, אנרגטי, מעודד — כמו חבר ותיק שאוהב ים",
                "emoji_policy": "light",
                "closing_tone": "קביעת שיעור ראשון",
                "language": "עברית משוחררת, לא פורמלית, חמה",
                "avoid": "שאלות עסקיות כמו תפקיד, גודל חברה, תקציב שנתי; לא להיות מכירתי מדי",
            },
            icp=None,
            differentiators=[
                "מדריכים מוסמכים ISA (International Surfing Association) עם 5+ שנות ניסיון הוראה",
                "יחס מדריך:תלמיד של 1:2-3 — לא קבוצות גדולות של 10 אנשים",
                "90% מהתלמידים עומדים על הגלשן כבר בשיעור הראשון",
                "ציוד מקצועי מתוחזק — לא גלשנים ישנים ושבורים",
                "ממוקמים על חוף גורדון — הגלים הכי נוחים ללמידה בתל אביב",
                "גמישות מלאה — ביטול עד 24 שעות לפני ללא חיוב",
            ],
            objections_playbook=[
                {
                    "objection": "יקר מדי / אין לי תקציב",
                    "response": (
                        "בהשוואה לרכישת ציוד (גלשן חדש = ₪2,000 לפחות), שיעור ב-₪280 כולל את כל הציוד — "
                        "זה הדרך הכי חסכונית להתנסות. "
                        "ואם ממש נהנה, חבילת 5 שיעורים ב-₪1,200 יוצאת ₪240 לשיעור."
                    ),
                },
                {
                    "objection": "אני לא ספורטיבי / לא חושב שאצליח",
                    "response": (
                        "זה בדיוק מה שכולם אומרים לפני השיעור הראשון. "
                        "90% מהתלמידים שלנו עומדים על הגלשן ביום הראשון — כולל אנשים בשנות ה-50 וה-60. "
                        "אנחנו מלמדים לפי הקצב שלך, לא קצב הקבוצה."
                    ),
                },
                {
                    "objection": "אין לי זמן / אני עסוק",
                    "response": (
                        "שיעור הוא 90 דקות. יש לנו שעות בוקר מוקדמות (07:00) ואחה\"צ (16:00). "
                        "קבוצות קטנות אז קל לתאם תאריך שמתאים לך."
                    ),
                },
                {
                    "objection": "ניסיתי בעבר ולא הצלחתי",
                    "response": (
                        "לרוב זה בגלל קבוצות גדולות מדי או מדריך שלא הסביר נכון. "
                        "אצלנו יחס של 1:2-3, ומתחילים מהיסודות — תנוחה, איזון, ואז הגלים. "
                        "הרבה אנשים שניסו במקום אחר ולא הצליחו — הצליחו אצלנו."
                    ),
                },
                {
                    "objection": "הים מסוכן / מפחד",
                    "response": (
                        "לגמרי מובן. לכן אנחנו מלמדים בחוף רדוד ומוגן. "
                        "כל השיעורים עם מדריך שנמצא לידך כל הזמן. "
                        "לומדים קודם בטיחות בים לפני שנכנסים לגלים."
                    ),
                },
            ],
            discovery_questions=[
                "האם גלשת בעבר, או שזה יהיה הפעם הראשונה?",
                "כמה אנשים מגיעים — רק אתה, זוג, חברים, ילדים?",
                "מה המטרה — להתנסות פעם אחת, ללמוד ברצינות, או לחפש פעילות קבועה?",
                "יש תאריך מסוים שנוח לך, או שאנחנו מחפשים את הזמן הקרוב ביותר שיש?",
                "בוקר מוקדם (07:00) עובד, או שעדיף אחרי הצהריים?",
            ],
            faq_kb_refs=[
                {
                    "q": "האם אני צריך ניסיון?",
                    "a": (
                        "לא! רוב הלקוחות מגיעים ללא שום ניסיון. "
                        "השיעורים מתחילים מאפס — תנוחה, איזון, ואז גלשן. "
                        "90% מהתלמידים עומדים על הגלשן כבר בשיעור הראשון."
                    ),
                },
                {
                ...
                },
                {
                    "q": "האם זה מסוכן?",
                    "a": (
                        "הגלישה המלמדת מתבצעת בחוף רדוד ומוגן. "
                        "כל השיעורים בפיקוח מדריך מוסמך שנמצא לידך כל הזמן. "
                        "מתחילים ללמוד בטיחות בים לפני הכניסה לגלים."
                    ),
                },
                {
                    "q": "מה שעות הפעילות?",
                ...
                },
                {
                    ...
                    "a": "ביטול עד 24 שעות לפני השיעור — ללא חיוב. ביטול פחות מ-24 שעות — 50% מהמחיר.",
                },
                {
                    "q": "האם אפשר כשיעור מתנה?",
                    "a": "בהחלט! המון אנשים קונים שיעור כמתנה ליום הולדת או לחגים. נוציא לך voucher שאפשר להדפיס.",
                },
                {
                    "q": "מה מינימום גיל לשיעור?",
                    "a": "גיל 8 ומעלה לשיעורים רגילים. לקייטנת הקיץ — גילאי 8-16.",
                },
                {
                    "q": "האם הים מתאים לגלישה כל השנה?",
                    "a": (
                        "כן! הים בתל אביב מתאים לגלישה כל השנה. "
                        "הגלים הכי טובים ללמידה הם בחורף (נובמבר-מרץ). "
                        "בקיץ הגלים יותר קטנים — מושלם למתחילים."
                    ),
                },
            ],
            case_studies=[
                {
                    "title": "דנה, 34, רואת חשבון — 'חשבתי שגלישה זה לא בשבילי'",
                    "industry": "B2C / Adult beginner",
                    "result": (
                        "הגיעה לשיעור ראשון עם הרבה ספקות. עמדה על הגלשן בשיעור הראשון. "
                        "אחרי חבילת 5 שיעורים — גולשת גלים קטנים לבד בכל סוף שבוע."
                    ),
                },
                {
                    "title": "משפחת לוי — שיעור משפחתי לשלושה ילדים",
                    "industry": "B2C / Family",
                    "result": (
                        "הורים ביקשו פעילות ים לילדים בגילאי 10, 13, 16. "
                        "כל השלושה עמדו על הגלשן. הבוגר הצטרף לקייטנת קיץ בהמשך."
                    ),
                },
            ],
            handoff_rules={
                "triggers": ["עורך דין", "תביעה", "נפצעתי", "תאונה", "תלונה רשמית"],
                "target_queue": "management",
                "user_msg_on_handoff": "אני מחבר אותך עם צוות הניהול שלנו — יחזרו אליך בהקדם.",
            },
            booking_link="https://almog-surf.co.il/book",
            cta_type="booking_link",
            meeting_length_min=90,
            custom_fields={
                "fields": {
            ...
            custom_prompt=(
                "אתה נציג מכירות של מועדון גלישה אלמוג — מועדון גלישה חברותי על חוף גורדון בתל אביב. "
                "הגישה שלך היא כמו חבר שאוהב ים — לא מוכר, לא לוחץ. "
                "\n\n"
                "תהליך השיחה: "
                "1. תמיד שאל שאלת גילוי אחת לפני שאתה מציג מחירים — הבן עם מי אתה מדבר (מתחיל? קבוצה? ילדים?). "
                "2. לאחר שאלת הגילוי — המלץ על המוצר הכי מתאים ל*אותו אדם ספציפית*, לא רשימה גנרית של כל המוצרים. "
                "3. אם עולה התנגדות (יקר/מפחד/אין זמן) — השתמש ב-objections_playbook. "
                "4. CTA הוא תמיד קביעת שיעור ראשון — לא 'תבדוק באתר' ולא 'תתקשר'. "
                "\n\n"
                "אל תמנה את כל המוצרים בפעם אחת. שאל קודם, המלץ אחר כך. "
                "שמור על שיחה קצרה וממוקדת — לא יותר מ-3-4 הודעות לפני שאתה מגיע ל-CTA."
            ),
        ))
        if inserted:
            print("✅ מועדון גלישה אלמוג seeded successfully.")
        else:
            print("✅ מועדון גלישה אלמוג record updated successfully.")
    except Exception as e:
        db.rollback()
